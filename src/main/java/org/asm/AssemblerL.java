...
public class AssemblerL {
    ...
    public static void readFile(String fileName) throws IOException {
        try (java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.FileReader(fileName))) {
            ...
            while ((line = reader.readLine()) != null) {
                writeFile("src/main/resources/test.hack", analyze(line));
            }
        }
    ...
    public static String analyze(String line) {
        ...
        return analyzeInstruction(instructionType, line);
    }

    public static InstructionType getInstructionType(String line) {
        if (StrUtil.isNotBlank(line)) {
            return StrUtil.startWith(line, "@") ? InstructionType.A : InstructionType.C;
        } else {
            throw new IllegalArgumentException("line is blank");
        }
    }

    public static String analyzeInstruction(InstructionType type, String insruction) {
        switch (type) {
            case A:
                return analyzeInstructionA(insruction);
            case C:
                return analyzeInstructionC(insruction);
            default:
